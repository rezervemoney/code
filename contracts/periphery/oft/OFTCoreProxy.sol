...
import {OAppPreCrimeSimulatorProxy} from "./OAppPreCrimeSimulatorProxy.sol";
import {
    IOFT,
    SendParam,
    OFTLimit,
...
import {OAppProxy} from "./OAppProxy.sol";
import {OAppOptionsType3Proxy} from "./OAppOptionsType3Proxy.sol";

/**
 * @title OFTCore
 * @dev Abstract contract for the OftChain (OFT) token.
 */
abstract contract OFTCoreProxy is IOFT, OAppProxy, OAppPreCrimeSimulatorProxy, OAppOptionsType3Proxy {
    ...
    uint16 public immutable SEND = 1;
    uint16 public immutable SEND_AND_CALL = 2;
     ...
     */
    function __OFTCoreProxy_init(uint8 _localDecimals, address _endpoint, address _delegate)
        internal
        onlyInitializing
    {
        __OAppProxy_init(_endpoint, _delegate);
